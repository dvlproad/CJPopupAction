...
//    WelcomeViewToPop *popupView = (WelcomeViewToPop *)[[[NSBundle bundleForClass:[self class]] loadNibNamed:@"WelcomeViewToPop" owner:nil options:nil] lastObject];
    WelcomePopupView *popupView = (WelcomePopupView *)[[[NSBundle bundleForClass:[self class]] loadNibNamed:@"WelcomePopupView" owner:nil options:nil] lastObject];
//    popupView.cjExtraOffset = 20;
    ...
    [popupView cj_showInCenterWindow:CJCenterWindowAnimationType3DSlideToCenter withSize:popupViewSize blankView:nil showComplete:^{
        NSLog(@"显示完成");
