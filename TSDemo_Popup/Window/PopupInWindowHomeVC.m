...
@interface PopupInWindowHomeVC ()<CJPopupViewDelegate>

@end

@implementation PopupInWindowHomeVC
...
- (WelcomePopupView *)welcomePopupView {
        NSBundle *resourceBunlde = [NSBundle bundleForClass:[self class]];
    //    WelcomeViewToPop *popupView = (WelcomeViewToPop *)[[[NSBundle mainBundle] loadNibNamed:@"WelcomeViewToPop" owner:nil options:nil] lastObject];
        WelcomePopupView *popupView = (WelcomePopupView *)[[resourceBunlde loadNibNamed:@"WelcomePopupView" owner:nil options:nil] lastObject];
...
- (void)popupInWindow_bottom1 {
    NSBundle *resourceBunlde = [NSBundle bundleForClass:[self class]];
    WelcomeViewToPop *popupView = (WelcomeViewToPop *)[[resourceBunlde loadNibNamed:@"WelcomeViewToPop" owner:nil options:nil] lastObject];
    popupView.popupViewDelegate = self;
